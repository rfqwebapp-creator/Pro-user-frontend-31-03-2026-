  ...
  <div className="relative">
    ...
    className="w-full border border-gray-300 rounded px-4 py-3"
  />
    {showCostCenterDropdown && costCenterSuggestions.length > 0 && (
      <div className="absolute z-50 w-full bg-white border border-gray-300 rounded mt-1 shadow max-h-48 overflow-y-auto">
